...
const recipes = [
  {
    ...
    instructions:
      "Cook spaghetti. Fry pancetta with garlic. Mix eggs and cheese. Combine all with spaghetti.",
    imageUrl:
  ...
  },
  {
    ...
    instructions:
      "Grill chicken. Chop lettuce and combine with dressing. Top with croutons and cheese.",
    imageUrl:
  ...
  },
  {
    ...
    instructions:
      "Chop vegetables and stir-fry with garlic and ginger. Add soy sauce and sesame seeds.",
    imageUrl:
